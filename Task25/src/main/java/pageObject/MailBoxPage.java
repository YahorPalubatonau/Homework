...
public class MailBoxPage extends AbstractPage {
    ...
    public void unselectAll() {
        unselectAllButton = webDriver.findElement(By.xpath(".//div[@id='b-toolbar__right']//div[@dataBase-cache-key='0_undefined_false']//div[@class='b-checkbox__checkmark']"));
    ...
    public void enterToWhom() throws SQLException {
        DataBase dataBase = new DataBase();
        fieldOfToWhom = webDriver.findElement(By.xpath(".//textarea[@dataBase-original-name='To']"));
        fieldOfToWhom.clear();
        fieldOfToWhom.sendKeys(dataBase.getEmail(1));
    }

    public void enterMessage() throws SQLException {
        DataBase dataBase =new DataBase();
